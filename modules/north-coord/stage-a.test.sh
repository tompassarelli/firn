...
grep -Fxq 'coord-restart-if-changed=true' "$off"
grep -Fxq 'coord-stop-if-changed=true' "$off"
...
grep -Fxq 'coord-restart-if-changed=true' "$on"
grep -Fxq 'coord-stop-if-changed=true' "$on"
grep -Fxq 'telemetry-restart-if-changed=true' "$on"
grep -Fxq 'telemetry-stop-if-changed=true' "$on"
