...
Agent/Task/Workflow while the /my-agent-config dispatch setting is `tern` — view/flip via
`my-agent-config` / `/my-agent-config` (alias `/myacfg`). Reinstated 2026-07-03; the P6 prose-only bet did not hold.)
