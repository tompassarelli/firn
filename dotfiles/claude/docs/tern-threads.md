# Tern threads — claim-native format
...
**There is ONE CLI/engine: `tern`** — `los` is **gone entirely**: thread ops
are `tern`, and time tracking is **`tern clock`** (claim-native sessions
...
`~/code/tern/docs/claim-native-redesign.md`.
